import type { PermissionKey, UserAccount } from "./users.types.js";

export const rolePermissions: Record<UserAccount["role"], PermissionKey[]> = {
  super_admin: [
    "dashboard.view",
    "colis.create",
    "colis.dispatch",
...
export const usersMock: UserAccount[] = [
  {
    id: "usr-super-admin",
    name: "Yacine G.",
